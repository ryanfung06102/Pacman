...
int main(void) {
	...
	while (1){
		for (haha = 0; haha < 100000 ; haha++);
		IERG3810_TFTLCD_ShowChinChar(96, 178, 0, red, black);
		IERG3810_TFTLCD_ShowChinChar(112, 178, 1, red, black);
		IERG3810_TFTLCD_ShowChinChar(128, 178, 2, red, black);
		IERG3810_TFTLCD_ShowString(144, 178, (u8*) "1155188577", red, black);
		IERG3810_TFTLCD_ShowChinChar(96, 162, 3, red, black);
		IERG3810_TFTLCD_ShowChinChar(112, 162, 4, red, black);
		IERG3810_TFTLCD_ShowChinChar(128, 162, 5, red, black);
		IERG3810_TFTLCD_ShowString(144, 162, (u8*) "1155187984", red, black);
	}
